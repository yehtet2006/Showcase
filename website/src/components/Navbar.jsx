...
function Navbar() {
  ...
  return (
    <>
      <nav className={`sidebar ${collapsed ? "collapsed" : ""}`} data-testid="sidebar">
        <ul>
          <li>
            <span className="logo">{!collapsed && "SpendIt"}</span>
            <button onClick={() => setCollapsed(!collapsed)} id="collapse-btn" data-testid="collapse-btn">
          ...
          <li className="nav-item">
            <NavLink to="/transactions" className={({ isActive }) => isActive ? "nav-link active" : "nav-link"} data-testid="nav-transactions">
              ...
              {!collapsed && <span>Transacties</span>}
            </NavLink>
          </li>
          <li className="nav-item">
            <NavLink to="/analytics" className={({ isActive }) => isActive ? "nav-link active" : "nav-link"} data-testid="nav-analytics">
          ...
          <li className="nav-item">
            <NavLink to='/settings' className={({ isActive }) => isActive ? "nav-link active" : "nav-link"} data-testid="nav-settings">
