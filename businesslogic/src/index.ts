...
// // Registering route handlers for user, category, and transaction related API endpoints
...
// // Start the server and listen on the specified port, logging the URL for the health check endpoint and the frontend URL to the console
// app.listen(ENV.PORT, () => {
